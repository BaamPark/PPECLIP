...
class CLIP(nn.Module):
    ...
    def forward_aggregate(self, image, text):
        #Global-Local Image-Text Similarity Aggregator
        #https://openaccess.thecvf.com/content/ICCV2023/papers/Abdelfattah_CDUL_CLIP-Driven_Unsupervised_Learning_for_Multi-Label_Image_Classification_ICCV_2023_paper.pdf
        #Higher ag_threshold → Only strong similarities are used, making predictions more confident but possibly missing weaker associations.
        #Lower ag_threshold → Allows weaker similarities, increasing recall but possibly introducing noise.
